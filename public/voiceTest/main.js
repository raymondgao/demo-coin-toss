...
function translateText() {
              ...
              var transText = document.getElementById("translate_quote")
              text = text.toString().replace('.', ',');

              var translate_text = document.getElementById('translate_quote').innerText
         ...
         $.ajax({
          ...
          .done(function(data) {
          var returnText =  JSON.parse(data.replace(/,+/g, ","))[0][0][0];
          transText.innerHTML = `<i class="fas fa-quote-left"></i>
                                 ${returnText}<i class="fas fa-quote-right"></i>
                               `;
...
function getQuote() {
 ...
 document.getElementById("translate_quote").innerHTML = ""

  var random = Math.floor(Math.random() * words.length); 

  currentQuote = words[random] ;
  currentQuote = currentQuote.trim();
      ...
      ${currentQuote}<i class="fas fa-quote-right"></i>
      `;
      document.getElementById("getQuote").style.backgroundColor = color;
      document.body.style.color = color;
      document.body.style.backgroundColor = color;
      document.getElementById("translate").style.backgroundColor = color;
      document.getElementById("translate").innerHTML = `Tiếng Việt`;
}
